...
namespace MultiserviciosPiscinas.Controllers
{
    ...
    public class RolesController : Controller
    {
        ...
        {
            var roles = await _context.Rols.Include(r => r.Usuarios).ToListAsync();
            return View(roles);
        }
        ...
        {
            var listaRoles = await _context.Rols.ToListAsync();
        ...
        public async Task<IActionResult> Crear(Usuario nuevoColaborador)
        {
            ...
            bool existeCorreo = await _context.Usuarios.AnyAsync(u => u.Correo == nuevoColaborador.Correo);
            if (existeCorreo)
            {
            ...
            try
            {
                _context.Usuarios.Add(nuevoColaborador);
